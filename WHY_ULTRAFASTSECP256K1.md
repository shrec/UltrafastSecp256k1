...
| CI workflows | 51 workflows, 16 platform combinations |
...
| **Total (audit runner)** | **unified_audit_runner** across 75 non-exploit modules + 232 exploit-PoC modules (248 total) | **~1,000,000+** |
| **Total (exploit PoC tests)** | **232 exploit-style PoC modules** across 20+ coverage categories, all in `audit/test_exploit_*.cpp` | **187 modules, 0 failures** |
