...
| **Total (audit runner)** | **unified_audit_runner** across 75 non-exploit modules + 171 exploit-PoC modules (246 total) | **~1,000,000+** |
...
| `security-audit.yml` | Runs the full `unified_audit_runner` (75 non-exploit + 171 exploit-PoC modules, ~1M assertions) plus sanitizer and warning gates | Every push |
