...
| [AUDIT_REPORT.md](AUDIT_REPORT.md) | Internal audit report (v4.2.0 baseline; test suite significantly restructured since -- see below) |
...
*UltrafastSecp256k1 v4.2.0 -- Security Policy*
