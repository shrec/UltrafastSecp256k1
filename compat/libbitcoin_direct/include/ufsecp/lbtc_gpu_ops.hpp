...
// six libbitcoin public-data batch ops (xonly/pubkey/taproot-commitment
// validate + tagged_hash / tagged_hash_var / hash256).
// ============================================================================
...
//     direct-GPU profile) installs 6 trampolines that call the matching
//     EXISTING GpuBackend virtual and translate GpuError -> {handled / -1
//     decline}. It self-installs via a file-scope static initializer retained
//     by the same -u secp256k1_gpu_columns_provider_anchor.
//
...
//   hash ops (tagged_hash / tagged_hash_var / hash256):
...
//
// All six ops operate on PUBLIC on-chain data (x-only / compressed pubkeys,
