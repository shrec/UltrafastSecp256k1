...
**Added in v3.69.0.** Provides non-interactive ZK proofs over secp256k1:
...
**⚠️ Status (v3.69.0):** API experimental. ZK primitives have internal audit coverage (`audit_zk.cpp`, ~1,500 checks). Bulletproof soundness is not formally proven for this implementation.

### 8. Ethereum Signing Layer (`secp256k1::eth`)

**Added in v3.69.0.** Provides Ethereum-specific signing (EIP-191, EIP-155, ecrecover):
...
## Automated Security Measures (v3.69.0)
...
| [AUDIT_REPORT.md](AUDIT_REPORT.md) | Internal audit report (v3.69.0 baseline; test suite has been restructured since) |
