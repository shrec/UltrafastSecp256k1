...
Usage:
    python3 ci/install_caas_hooks.py          # install
    python3 ci/install_caas_hooks.py --remove # uninstall
    python3 ci/install_caas_hooks.py --status # check if installed
...
#   git push --no-verify
# To uninstall:
#   python3 ci/install_caas_hooks.py --remove

REPO_ROOT="$(git rev-parse --show-toplevel)"
RUNNER="$REPO_ROOT/ci/caas_runner.py"
