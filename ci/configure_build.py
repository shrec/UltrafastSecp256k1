...
Usage:
  python3 ci/configure_build.py <profile> [extra cmake args...]
  python3 ci/configure_build.py --list
  python3 ci/configure_build.py --configure-only <profile>
  python3 ci/configure_build.py --build <profile>
...
after migrating to out/<profile>. Run ci/clean_local_artifacts.sh to remove them.
"""
...
def list_profiles() -> None:
    ...
    print()
    print("Usage: python3 ci/configure_build.py <profile> [extra cmake args...]")
