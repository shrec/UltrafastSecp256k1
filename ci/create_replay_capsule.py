...
Usage
-----
    python3 ci/create_replay_capsule.py
    python3 ci/create_replay_capsule.py --profile release --json
    python3 ci/create_replay_capsule.py --output /tmp/capsule.json
...
def build_capsule(profile: str) -> dict:
    ...
    capsule = {
        ...
        "replay_commands": [
            ...
            "ninja -C build",
            f"python3 ci/caas_runner.py --profile {profile} --json -o caas_report.json",
