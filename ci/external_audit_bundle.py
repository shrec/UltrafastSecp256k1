...
GATE_COMMANDS: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "cmd": [sys.executable, "ci/audit_gap_report.py", "--json", "--strict"],
        "required": True,
    },
    {
        "name": "security_autonomy_check",
        "cmd": [sys.executable, "ci/security_autonomy_check.py", "--json"],
        "required": True,
    },
    {
        "name": "supply_chain_gate",
        "cmd": [sys.executable, "ci/supply_chain_gate.py", "--json"],
        "required": True,
    },
]
