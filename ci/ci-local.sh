...
#   ./ci/ci-local.sh all
#   ./ci/ci-local.sh dev-gate
#   ./ci/ci-local.sh main-gate
#   ./ci/ci-local.sh branch-gate
#   ./ci/ci-local.sh install-hook
#   ./ci/ci-local.sh <service-name>
#
# Optional:
#   ./ci/ci-local.sh --build gh-parity
#   ./ci/ci-local.sh --list
# =============================================================================
set -euo pipefail
...
HOOK
    ...
    echo "Hook behavior: runs './ci/ci-local.sh branch-gate' before every push."
    exit 0
fi
