...
def _cmd_for_name(name: str) -> list[str] | None:
    mapping = {
        "audit_gate": [sys.executable, "ci/audit_gate.py", "--json"],
        "audit_gap_report_strict": [sys.executable, "ci/audit_gap_report.py", "--json", "--strict"],
        "security_autonomy_check": [sys.executable, "ci/security_autonomy_check.py", "--json"],
        "supply_chain_gate": [sys.executable, "ci/supply_chain_gate.py", "--json"],
    }
...
def run_deep_replay(
    ...
    always_run: list[dict] = [
        {
            "label": "audit_gate",
            "cmd": [sys.executable, "ci/audit_gate.py", "--json",
    ...
    optional_scripts = [
        "ci/check_libsecp_shim_parity.py",
        "ci/check_core_build_mode.py",
    ]
