...
2. P5 multiply/square and sparse-prime reducer controls now have full accumulator
   bounds, native measurements and emitted-code evidence. Next isolate actual
   API/raw-ASM observation costs, investigate unrolled/fused schedules and replicate
   compiler profiles before transferring the conditional row-chain candidate.
...
[P5 measured 25-lens outcomes](P5_FIELD_PRODUCT_LENS_RESULTS.md).
...
Original P2/P3/P4 manifests remain unchanged. Relative links inside byte snapshots
