...
- Every commit runs 1,000,000+ assertions across 89 non-exploit audit modules and 238 exploit PoCs
...
| Audit modules (`unified_audit_runner`) | **89 non-exploit modules + 238 exploit PoCs across 9 sections, 0 failures** |
...
The `unified_audit_runner` executes **89 non-exploit audit modules + 238 exploit PoCs** across 9 sections
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 89 non-exploit modules + 238 exploit PoCs and platform verdicts |
