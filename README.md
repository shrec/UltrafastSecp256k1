...
- Every commit runs 1,000,000+ assertions across 89 non-exploit audit modules and 237 exploit PoCs
...
| Audit modules (`unified_audit_runner`) | **89 non-exploit modules + 237 exploit PoCs across 9 sections, 0 failures** |
...
The `unified_audit_runner` executes **89 non-exploit audit modules + 237 exploit PoCs** across 9 sections
