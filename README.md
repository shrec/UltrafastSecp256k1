...
- All 106 non-exploit audit modules and all 261 exploit PoCs return `AUDIT-READY` status as of the last CAAS gate run. Zero failures — see pinned evidence: [`docs/EXTERNAL_AUDIT_BUNDLE.json`](docs/EXTERNAL_AUDIT_BUNDLE.json).
...
The `unified_audit_runner` executes **106 non-exploit audit modules + 261 exploit PoCs** across 9 sections
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 106 non-exploit modules + 261 exploit PoCs and platform verdicts |
