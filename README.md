...
- Every commit runs 1,000,000+ assertions across 105 non-exploit audit modules and 261 exploit PoCs (354 modules total; count via `python3 ci/sync_module_count.py`)
...
| Audit modules (`unified_audit_runner`) | **105 non-exploit modules + 261 exploit PoCs across 9 sections, 0 failures** |
...
- All 105 non-exploit audit modules and all 261 exploit PoCs return `AUDIT-READY` status as of the last CAAS gate run. Zero failures — see pinned evidence: [`docs/EXTERNAL_AUDIT_BUNDLE.json`](docs/EXTERNAL_AUDIT_BUNDLE.json).
...
The `unified_audit_runner` executes **105 non-exploit audit modules + 261 exploit PoCs** across 9 sections
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 105 non-exploit modules + 261 exploit PoCs and platform verdicts |
