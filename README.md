...
- Every commit runs 1,000,000+ assertions across 92 non-exploit audit modules and 252 exploit PoCs
...
| Audit modules (`unified_audit_runner`) | **92 non-exploit modules + 252 exploit PoCs across 9 sections, 0 failures** |
...
- All 92 non-exploit audit modules and all 252 exploit PoCs return `AUDIT-READY` status. Zero failures across all tested platforms.
...
The `unified_audit_runner` executes **92 non-exploit audit modules + 252 exploit PoCs** across 9 sections
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 92 non-exploit modules + 252 exploit PoCs and platform verdicts |
