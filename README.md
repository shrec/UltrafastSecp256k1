...
- Every commit runs 1,000,000+ assertions across 90 non-exploit audit modules and 238 exploit PoCs
...
| Audit modules (`unified_audit_runner`) | **90 non-exploit modules + 238 exploit PoCs across 9 sections, 0 failures** |
...
- All 90 non-exploit audit modules and all 235 exploit PoCs return `AUDIT-READY` status. Zero failures across all tested platforms.
...
The `unified_audit_runner` executes **90 non-exploit audit modules + 238 exploit PoCs** across 9 sections
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 90 non-exploit modules + 238 exploit PoCs and platform verdicts |
