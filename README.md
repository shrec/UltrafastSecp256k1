...
- Every commit runs 1,000,000+ assertions across 103 non-exploit audit modules and 261 exploit PoCs (354 modules total; count via `python3 ci/sync_module_count.py`)
...
The `unified_audit_runner` executes **103 non-exploit audit modules + 261 exploit PoCs** across 9 sections
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 103 non-exploit modules + 261 exploit PoCs and platform verdicts |
