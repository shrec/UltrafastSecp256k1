...
- Every commit runs ~1,000,000+ assertions (aggregate estimate) across 146 non-exploit audit modules and 273 exploit PoCs ( 420 modules total; count via `python3 ci/sync_module_count.py`; canonical data: `docs/canonical_data.json`)
