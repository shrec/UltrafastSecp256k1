...
- Every commit runs 1,000,000+ assertions across 97 non-exploit audit modules and 239 exploit PoCs
...
The `unified_audit_runner` executes **97 non-exploit audit modules + 239 exploit PoCs** across 9 sections
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 97 non-exploit modules + 239 exploit PoCs and platform verdicts |
