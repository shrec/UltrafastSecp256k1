...
- Every commit runs 1,000,000+ assertions across 91 non-exploit audit modules and 252 exploit PoCs
...
The `unified_audit_runner` executes **91 non-exploit audit modules + 252 exploit PoCs** across 9 sections
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 91 non-exploit modules + 252 exploit PoCs and platform verdicts |
