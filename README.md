...
- Every commit runs 1,000,000+ assertions across 98 non-exploit audit modules and 239 exploit PoCs
...
| Audit modules (`unified_audit_runner`) | **98 non-exploit modules + 239 exploit PoCs across 9 sections, 0 failures** |
...
- All 98 non-exploit audit modules and all 239 exploit PoCs return `AUDIT-READY` status. Zero failures across all tested platforms.
...
The `unified_audit_runner` executes **98 non-exploit audit modules + 239 exploit PoCs** across 9 sections
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 98 non-exploit modules + 239 exploit PoCs and platform verdicts |
