...
> **Audit methodology:** CAAS (Continuous Automated Assurance System) — a multi-layer automated audit framework: LLVM ct-verif, Valgrind taint analysis, dudect statistical timing, 441-module unified runner with 272 exploit PoC tests.
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 169 non-exploit modules + 272 exploit PoCs and platform verdicts |
