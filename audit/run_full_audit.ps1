...
function Generate-AuditReportMd {
    ...
    [void]$sb.AppendLine("- No machine-checked proof framework (Vale/Jasmin/Coq/Fiat-Crypto generated proofs) applied")
    ...
    [void]$sb.AppendLine("")
    [void]$sb.AppendLine("CT verification uses a layered approach:")
    [void]$sb.AppendLine("")
    ...
    [void]$sb.AppendLine("|-------------------------------|---------------|----------|")
    [void]$sb.AppendLine("| A1: Timing Side Channels | CT tests, dudect, ct-verif, valgrind-ct, disasm scan | unified runner (ct_analysis) + CI (ct-verif.yml) |")
