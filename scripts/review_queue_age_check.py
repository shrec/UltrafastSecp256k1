...
Usage:
    python3 scripts/review_queue_age_check.py
    python3 scripts/review_queue_age_check.py --json -o review_queue_age.json
    python3 scripts/review_queue_age_check.py --strict
"""
