...
Usage:
  python3 scripts/run_code_quality.py                      # human-readable
  python3 scripts/run_code_quality.py --json -o report.json # JSON report
  python3 scripts/run_code_quality.py --fail-on-regression  # CI gate mode
  python3 scripts/run_code_quality.py --update-baseline     # refresh baseline
"""
