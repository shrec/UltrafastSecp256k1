...
Usage:
    python3 scripts/artifact_analyzer.py ingest report1.json [report2.json ...]
    python3 scripts/artifact_analyzer.py diff --before a.json --after b.json
    python3 scripts/artifact_analyzer.py timeline --db analyzer.db
    python3 scripts/artifact_analyzer.py export --format sarif|markdown|timeline
    python3 scripts/artifact_analyzer.py divergence r1.json r2.json [r3.json ...]
    python3 scripts/artifact_analyzer.py flakes --db analyzer.db --window 10
"""
