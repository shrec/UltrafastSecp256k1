...
--------------
  ...
  python3 scripts/hot_path_alloc_scanner.py

  # Scan just cpu/src:
  python3 scripts/hot_path_alloc_scanner.py --src-dir cpu/src

  # JSON output to file:
  python3 scripts/hot_path_alloc_scanner.py --json -o report.json

  # Non-zero exit when any HIGH finding exists:
  python3 scripts/hot_path_alloc_scanner.py --fail-on-high
"""
