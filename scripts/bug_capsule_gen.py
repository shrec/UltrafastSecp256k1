...
Usage:
    python3 scripts/bug_capsule_gen.py capsule.json             # single capsule
    python3 scripts/bug_capsule_gen.py schemas/bug_capsules/     # directory of capsules
    python3 scripts/bug_capsule_gen.py --list schemas/bug_capsules/  # list only, no generate
    python3 scripts/bug_capsule_gen.py --cmake schemas/bug_capsules/ # emit CMake fragment
"""
...
def generate_cmake_fragment(capsules: list[dict]) -> str:
    ...
    lines = [
        ...
        '# DO NOT EDIT — regenerate with: python3 scripts/bug_capsule_gen.py --cmake schemas/bug_capsules/',
        '',
    ]
