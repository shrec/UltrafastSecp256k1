/**
 * ESP32-C6 Unified Audit Runner -- Full secp256k1 verification for RISC-V target
 *
 * Adapted from audit/unified_audit_runner.cpp and tests/esp32_audit/main/audit_main.cpp
 * for the ESP32-C6 (single-core RISC-V LP @ 160 MHz, rv32imac_zicsr_zifencei).
 *
 ...
 *
 * API: v3.16.0
 * Target: ESP32-C6 (RISC-V LP 160 MHz)
...
static const char* TAG = "secp256k1_audit_c6";
#define LOG(fmt, ...) ESP_LOGI(TAG, fmt, ##__VA_ARGS__)
#else
#define LOG(fmt, ...) printf("[AUDIT_C6] " fmt "\n", ##__VA_ARGS__)
#endif
...
{
    LOG("+==========================================================+");
    LOG("|  UltrafastSecp256k1 ESP32-C6 Audit Runner v3.16.0      |");
    LOG("|  Audit Framework v2.0.0 -- RISC-V C6 Adaptation        |");
    LOG("+==========================================================+");
    LOG("|  Target: ESP32-C6 (RISC-V LP, 160 MHz)                 |");
    LOG("|  Arch:   rv32imac / SECP256K1_NO_ASM / 26-bit field    |");
    LOG("|  Modules: %d / %d                                   |",
    ...
    LOG("  Platform:       ESP32-C6 RISC-V LP | ESP-IDF 5.4.0");
    LOG("============================================================");
