...
// This file intentionally exercises the legacy variable-time
// secp256k1::ecdsa_sign / secp256k1::schnorr_sign entry points (their CT
// counterparts have separate equivalence coverage in test_ct_equivalence.cpp).
