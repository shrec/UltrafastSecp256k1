...
### What It Tests ( 189 non-exploit modules + 276 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 465 modules, 8 sections)
...
### Metal Audit Runner ( 465 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 465 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 465 modules) |
