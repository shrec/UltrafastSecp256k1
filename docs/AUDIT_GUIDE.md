...
### What It Tests ( 168 non-exploit modules + 271 exploit PoC tests + standalone audit surfaces)
...
| **Exploit PoC Suite** | **271 exploit-PoC modules** | ECDSA malleability, ECDH degenerate, GLV decomposition, BIP-32 overflow, MuSig2 nonce reuse, FROST Byzantine, AEAD integrity, Taproot, ElligatorSwift, CT systematic, and more (14 categories) |
...
### OpenCL Audit Runner ( 439 modules, 8 sections)
...
### Metal Audit Runner ( 439 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 439 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 439 modules) |
