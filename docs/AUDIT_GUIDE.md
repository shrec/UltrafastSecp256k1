...
### What It Tests ( 123 non-exploit modules + 269 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 392 modules, 8 sections)
...
### Metal Audit Runner ( 392 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 392 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 392 modules) |
