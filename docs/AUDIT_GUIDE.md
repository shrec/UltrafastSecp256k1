...
### What It Tests ( 163 non-exploit modules + 269 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 432 modules, 8 sections)
...
### Metal Audit Runner ( 432 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 432 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 432 modules) |
