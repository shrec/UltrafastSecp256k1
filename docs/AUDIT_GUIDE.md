...
### What It Tests ( 184 non-exploit modules + 275 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 459 modules, 8 sections)
...
### Metal Audit Runner ( 459 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 459 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 459 modules) |
