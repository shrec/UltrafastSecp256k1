...
### What It Tests ( 184 non-exploit modules + 276 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 460 modules, 8 sections)
...
### Metal Audit Runner ( 460 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 460 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 460 modules) |
