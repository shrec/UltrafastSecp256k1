...
### What It Tests ( 169 non-exploit modules + 272 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 441 modules, 8 sections)
...
### Metal Audit Runner ( 441 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 441 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 441 modules) |
