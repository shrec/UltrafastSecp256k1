...
| **Exploit PoC Suite** | **264 exploit-PoC modules** | ECDSA malleability, ECDH degenerate, GLV decomposition, BIP-32 overflow, MuSig2 nonce reuse, FROST Byzantine, AEAD integrity, Taproot, ElligatorSwift, CT systematic, and more (14 categories) |
...
### OpenCL Audit Runner ( 376 modules, 8 sections)
...
### Metal Audit Runner ( 376 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 376 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 376 modules) |
