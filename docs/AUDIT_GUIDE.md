...
### What It Tests ( 125 non-exploit modules + 270 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 395 modules, 8 sections)
...
### Metal Audit Runner ( 395 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 395 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 395 modules) |
