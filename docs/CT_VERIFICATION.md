...
**UltrafastSecp256k1 v4.4.0** -- CT Layer Methodology & Audit Status
...
- Audited via `opencl_audit_runner` ( 433 modules including CT sections)
...
- Audited via `metal_audit_runner` ( 433 modules including CT sections)
...
- **OpenCL**: `opencl_audit_runner` ( 433 modules including CT signing + CT ZK sections)
- **Metal**: `metal_audit_runner` ( 433 modules including CT signing + CT ZK sections)
...
*UltrafastSecp256k1 v4.4.0 -- CT Verification*
