...
> **x86-64 (i5-14400F): 2026-09-03** GCC 14.2.0, turbo lock CONFIRMED (intel_pstate/no_turbo=1, governor=performance, sudo-pinned), core 0 pinned (taskset -c 0 nice -20), 500 warmup/op, 11-pass IQR median  
> Canonical JSON: `docs/bench_unified_2026-09-03_gcc14_x86-64.json` (machine-generated by `bench_unified --json`; `generated_by` field present)  
> Other platforms: pending fresh controlled runs.

x86-64: GCC 14.2.0 · i5-14400F · 2.496 GHz · turbo CONFIRMED disabled · core 0 pinned · **11-pass IQR** · Release+LTO · 2026-09-03
...
> **CT Sign vs lib** = `bench_unified` CT-vs-CT section — production-equivalent comparison. Canonical data: `docs/bench_unified_2026-09-03_gcc14_x86-64.json`.
...
|--------|--------------------|
| Field Mul, Generator Mul, Scalar Mul, ECDSA Verify | `docs/bench_unified_2026-09-03_gcc14_x86-64.json` |
| CT Sign vs lib (ECDSA 1.34×, Schnorr 1.27× — turbo lock CONFIRMED) | `docs/bench_unified_2026-09-03_gcc14_x86-64.json` |
| Verify vs lib (warm-cache) | `docs/bench_unified_2026-09-03_gcc14_x86-64.json` |
