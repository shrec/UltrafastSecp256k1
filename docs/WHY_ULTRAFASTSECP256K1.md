...
| **Total (audit runner)** | **unified_audit_runner** across 112 non-exploit modules + 264 exploit-PoC modules (371 total) | **~1,000,000+** |
| **Total (exploit PoC tests)** | **264 exploit-PoC modules** across 20+ coverage categories, all in `audit/test_exploit_*.cpp` | **263 modules, 0 failures** |
