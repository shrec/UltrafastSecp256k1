...
| Exploit PoC tests | 261 dedicated adversarial PoC modules across 20+ coverage categories (`audit/test_exploit_*.cpp`) | 260 wired, 0 failures |
...
| **Total (audit runner)** | **unified_audit_runner** across 102 non-exploit modules + 261 exploit PoCs modules (360 total) | **~1,000,000+** |
| **Total (exploit PoC tests)** | **261 exploit PoCs modules** across 20+ coverage categories, all in `audit/test_exploit_*.cpp` | **257 modules, 0 failures** |
