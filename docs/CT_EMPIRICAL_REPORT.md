...
**UltrafastSecp256k1 v3.50.0** -- Statistical Timing Analysis
...
> variance** in any `ct::` namespace operation of UltrafastSecp256k1 v3.50.0.
>
...
*UltrafastSecp256k1 v3.50.0 — CT Empirical Proof Report v2.0*
