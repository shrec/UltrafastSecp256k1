...
> **Library Version:** UltrafastSecp256k1 v4.2.1  
> **Commit:** 1dcdb8d
...
**Advisory warning:** Side-channel dudect smoke test ( 428 modules)  
...
**Audit Certification:** This document certifies that UltrafastSecp256k1 v4.2.1 passes all security, correctness, and constant-time requirements on ARM64 (AArch64) platforms as of commit 1dcdb8d (2026-03-06).
