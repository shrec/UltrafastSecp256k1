...
> **Library Version:** UltrafastSecp256k1 v3.50.0  
> **Commit:** 1dcdb8d
...
**Audit Certification:** This document certifies that UltrafastSecp256k1 v3.50.0 passes all security, correctness, and constant-time requirements on ARM64 (AArch64) platforms as of commit 1dcdb8d (2026-03-06).
