...
[
    ...
    [ "Installation", "index.html#autotoc_md29", [
      ...
      [ "Use with pkg-config", "index.html#autotoc_md35", null ]
    ] ],
    [ "secp256k1 GPU Acceleration (CUDA / OpenCL / Metal / ROCm)", "index.html#autotoc_md37", [
    ...
    [ "WASM secp256k1 (Browser & Node.js)", "index.html#autotoc_md58", null ],
    [ "secp256k1 Batch Modular Inverse (Montgomery Trick)", "index.html#autotoc_md60", [
      [ "Mixed Addition (Jacobian + Affine)", "index.html#autotoc_md61", null ],
    ...
    [ "secp256k1 Use Cases", "index.html#autotoc_md68", null ],
    [ "</blockquote>", "index.html#autotoc_md69", null ],
    [ "Building secp256k1 from Source (CMake)", "index.html#autotoc_md70", [
      [ "Prerequisites", "index.html#autotoc_md71", null ],
      [ "CPU-Only Build", "index.html#autotoc_md72", null ],
      [ "With CUDA GPU Support", "index.html#autotoc_md73", null ],
      [ "WebAssembly (Emscripten)", "index.html#autotoc_md74", null ],
      [ "iOS (XCFramework)", "index.html#autotoc_md75", null ],
      [ "Build Options", "index.html#autotoc_md76", null ]
    ] ],
    [ "secp256k1 Quick Start (C++ Examples)", "index.html#autotoc_md78", [
      [ "Basic Point Operations", "index.html#autotoc_md79", null ],
      [ "GPU Batch Multiplication", "index.html#autotoc_md80", null ]
    ] ],
    [ "secp256k1 Security Model (FAST vs CT)", "index.html#autotoc_md82", [
      [ "FAST Profile (Default)", "index.html#autotoc_md83", null ],
      [ "CT / Hardened Profile (<tt>ct::</tt> namespace)", "index.html#autotoc_md84", null ]
    ] ],
    [ "secp256k1 Supported Coins (27 Blockchains)", "index.html#autotoc_md86", null ],
    [ "secp256k1 Architecture", "index.html#autotoc_md88", null ],
    [ "secp256k1 Testing & Verification", "index.html#autotoc_md90", [
      [ "Built-in Selftest", "index.html#autotoc_md91", null ],
      [ "Sanitizer Builds", "index.html#autotoc_md92", null ],
      [ "Fuzz Testing", "index.html#autotoc_md93", null ],
      [ "Platform CI Coverage", "index.html#autotoc_md94", null ]
    ] ],
