...
| **Audit runner** | `unified_audit_runner` (183 non-exploit + 275 exploit PoCs = 458 modules) | `gpu_audit_runner` ( 459 modules) | `opencl_audit_runner` ( 459 modules) | `metal_audit_runner` ( 459 modules) |
