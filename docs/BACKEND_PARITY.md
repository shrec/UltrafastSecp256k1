...
**Last updated**: 2026-04-21 | **Version**: 4.3.0
...
| **Audit runner** | `unified_audit_runner` (161 non-exploit + 269 exploit PoCs = 430 modules) | `gpu_audit_runner` ( 430 modules) | `opencl_audit_runner` ( 430 modules) | `metal_audit_runner` ( 430 modules) |
