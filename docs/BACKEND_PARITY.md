...
| **Audit runner** | `unified_audit_runner` (159 non-exploit + 269 exploit PoCs = 428 modules) | `gpu_audit_runner` ( 428 modules) | `opencl_audit_runner` ( 428 modules) | `metal_audit_runner` ( 428 modules) |
