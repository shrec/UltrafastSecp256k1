...
| **Audit runner** | `unified_audit_runner` (186 non-exploit + 276 exploit PoCs = 462 modules) | `gpu_audit_runner` ( 464 modules) | `opencl_audit_runner` ( 464 modules) | `metal_audit_runner` ( 464 modules) |
