...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 271 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 403 modules) | `opencl_audit_runner` ( 403 modules) | `metal_audit_runner` ( 403 modules) |
