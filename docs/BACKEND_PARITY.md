...
| **Audit runner** | `unified_audit_runner` (169 non-exploit + 272 exploit PoCs = 441 modules) | `gpu_audit_runner` ( 441 modules) | `opencl_audit_runner` ( 441 modules) | `metal_audit_runner` ( 441 modules) |
