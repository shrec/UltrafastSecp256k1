...
| **Audit runner** | `unified_audit_runner` (166 non-exploit + 270 exploit PoCs = 436 modules) | `gpu_audit_runner` ( 436 modules) | `opencl_audit_runner` ( 436 modules) | `metal_audit_runner` ( 436 modules) |
