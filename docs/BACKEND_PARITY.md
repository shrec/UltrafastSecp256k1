...
| **Audit runner** | `unified_audit_runner` (163 non-exploit + 269 exploit PoCs = 432 modules) | `gpu_audit_runner` ( 432 modules) | `opencl_audit_runner` ( 432 modules) | `metal_audit_runner` ( 432 modules) |
