...
| **Audit runner** | `unified_audit_runner` (164 non-exploit + 269 exploit PoCs = 433 modules) | `gpu_audit_runner` ( 433 modules) | `opencl_audit_runner` ( 433 modules) | `metal_audit_runner` ( 433 modules) |
