...
| **Audit runner** | `unified_audit_runner` (171 non-exploit + 272 exploit PoCs = 443 modules) | `gpu_audit_runner` ( 443 modules) | `opencl_audit_runner` ( 443 modules) | `metal_audit_runner` ( 443 modules) |
