...
| **Audit runner** | `unified_audit_runner` (162 non-exploit + 269 exploit PoCs = 431 modules) | `gpu_audit_runner` ( 431 modules) | `opencl_audit_runner` ( 431 modules) | `metal_audit_runner` ( 431 modules) |
