...
| **Audit runner** | `unified_audit_runner` (173 non-exploit + 272 exploit PoCs = 445 modules) | `gpu_audit_runner` ( 445 modules) | `opencl_audit_runner` ( 445 modules) | `metal_audit_runner` ( 445 modules) |
