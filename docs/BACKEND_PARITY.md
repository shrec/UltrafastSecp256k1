...
**Last updated**: 2026-04-21 | **Version**: 4.1.1
...
| **Audit runner** | `unified_audit_runner` (149 non-exploit + 269 exploit PoCs = 418 modules) | `gpu_audit_runner` ( 418 modules) | `opencl_audit_runner` ( 418 modules) | `metal_audit_runner` ( 418 modules) |
