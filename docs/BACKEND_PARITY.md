...
| **Audit runner** | `unified_audit_runner` (184 non-exploit + 276 exploit PoCs = 460 modules) | `gpu_audit_runner` ( 460 modules) | `opencl_audit_runner` ( 460 modules) | `metal_audit_runner` ( 460 modules) |
