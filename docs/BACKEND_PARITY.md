...
| **Audit runner** | `unified_audit_runner` (175 non-exploit + 272 exploit PoCs = 447 modules) | `gpu_audit_runner` ( 447 modules) | `opencl_audit_runner` ( 447 modules) | `metal_audit_runner` ( 447 modules) |
