...
| **Audit runner** | `unified_audit_runner` (185 non-exploit + 276 exploit PoCs = 461 modules) | `gpu_audit_runner` ( 461 modules) | `opencl_audit_runner` ( 461 modules) | `metal_audit_runner` ( 461 modules) |
