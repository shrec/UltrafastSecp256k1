...
| **Audit runner** | `unified_audit_runner` (174 non-exploit + 272 exploit PoCs = 446 modules) | `gpu_audit_runner` ( 446 modules) | `opencl_audit_runner` ( 446 modules) | `metal_audit_runner` ( 446 modules) |
