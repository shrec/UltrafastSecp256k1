...
| **Audit runner** | `unified_audit_runner` (149 non-exploit + 270 exploit PoCs = 419 modules) | `gpu_audit_runner` ( 419 modules) | `opencl_audit_runner` ( 419 modules) | `metal_audit_runner` ( 419 modules) |
