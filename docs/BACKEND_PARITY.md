...
| **Audit runner** | `unified_audit_runner` (170 non-exploit + 272 exploit PoCs = 442 modules) | `gpu_audit_runner` ( 442 modules) | `opencl_audit_runner` ( 442 modules) | `metal_audit_runner` ( 442 modules) |
