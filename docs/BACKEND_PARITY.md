...
| **Audit runner** | `unified_audit_runner` (166 non-exploit + 271 exploit PoCs = 436 modules) | `gpu_audit_runner` ( 439 modules) | `opencl_audit_runner` ( 439 modules) | `metal_audit_runner` ( 439 modules) |
