...
| **Audit runner** | `unified_audit_runner` (151 non-exploit + 269 exploit PoCs = 420 modules) | `gpu_audit_runner` ( 420 modules) | `opencl_audit_runner` ( 420 modules) | `metal_audit_runner` ( 420 modules) |
