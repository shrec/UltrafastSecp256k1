...
| **Audit runner** | `unified_audit_runner` (191 non-exploit + 276 exploit PoCs = 467 modules) | `gpu_audit_runner` ( 467 modules) | `opencl_audit_runner` ( 467 modules) | `metal_audit_runner` ( 467 modules) |
