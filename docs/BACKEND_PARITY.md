...
| **Audit runner** | `unified_audit_runner` (172 non-exploit + 272 exploit PoCs = 444 modules) | `gpu_audit_runner` ( 444 modules) | `opencl_audit_runner` ( 444 modules) | `metal_audit_runner` ( 444 modules) |
