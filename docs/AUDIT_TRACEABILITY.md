...
**UltrafastSecp256k1 v4.4.0** -- Evidence-Based Correctness & Security Mapping
...
- CUDA: `src/cuda/src/gpu_audit_runner.cu` ( 432 modules)
- OpenCL: `opencl/src/opencl_audit_runner.cpp` ( 432 modules)
- Metal: `metal/src/metal_audit_runner.mm` ( 432 modules)
