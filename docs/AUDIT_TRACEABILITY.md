...
**UltrafastSecp256k1 v4.2.1** -- Evidence-Based Correctness & Security Mapping
...
- CUDA: `src/cuda/src/gpu_audit_runner.cu` ( 428 modules)
- OpenCL: `opencl/src/opencl_audit_runner.cpp` ( 428 modules)
- Metal: `metal/src/metal_audit_runner.mm` ( 428 modules)
