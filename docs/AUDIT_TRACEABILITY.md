...
**UltrafastSecp256k1 v4.1.1** -- Evidence-Based Correctness & Security Mapping
...
- CUDA: `src/cuda/src/gpu_audit_runner.cu` ( 418 modules)
- OpenCL: `opencl/src/opencl_audit_runner.cpp` ( 418 modules)
- Metal: `metal/src/metal_audit_runner.mm` ( 418 modules)
