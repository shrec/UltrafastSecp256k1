...
| Audit modules | 418 across 9 failure classes |
...
|----------------------|---------------------------------------------|
| Audit Sections       | 8                                           |
| Audit Modules        | 149 (non-exploit modules) |
...
*Generated from unified_audit_runner v4.2.0 output + CI workflow analysis. Last updated 2026-04-01.*
